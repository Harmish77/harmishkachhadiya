class TerminalResume {
  ...
  handleCommand(inputElement) {
    ...
    switch (cmd) {
      ...
      case "disable":
      case "false":
        window.location.href = 'index.html?terminal=false';
        break;
      case "":
        break;
      default:
...
╚═╝  ╚═╝╚═╝  ╚═╝`;
    ...
    const welcome =
      ...
      this.wrapWithColor(
        "         Student Developer • Independent Builder • IoT & Bots\n",
        "#666666"
      ) +
      this.wrapWithColor(divider + "\n\n", "#555555") +
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Student Developer & Independent Builder from India.",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Building web apps, REST APIs, and IoT systems.",
      "#ffffff"
    )}
${this.wrapWithColor(
  "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor(
  "   ASP.NET Core APIs, Telegram Bot API,",
  "#ffffff"
)}
${this.wrapWithColor("   and IoT projects with NodeMCU ESP8266", "#ff8c00")}
...
${this.wrapWithColor(
  "   from file streaming bots to smart irrigation systems",
  "#ffffff"
)}

${this.wrapWithColor("⚡ Strengths", "#ff8c00")}
${this.wrapWithColor(
  "   Self-taught, practical builder who ships things.",
  "#ffffff"
)}
${this.wrapWithColor("   Always learning, always building.", "#ffffff")}
...
<span style="color: #00ffff;">TELEGRAM MOVIE STREAMING WEBSITE</span>
${this.wrapWithColor(
  "2024 | Express.js, Telegram Bot API, Koyeb, Vercel",
  "#ffffff"
)}

• ${this.wrapWithColor("File streaming", "#ffa07a")} - ${this.wrapWithColor(
      "Stream movies directly from Telegram using MTProto",
      "#ffffff"
    )}
• ${this.wrapWithColor("Full-stack", "#ffa07a")} - ${this.wrapWithColor(
      "Express.js backend for seamless UX",
      "#ffffff"
    )}
• ${this.wrapWithColor("Deployed", "#ffa07a")} - ${this.wrapWithColor(
      "Backend on Koyeb, frontend on Vercel",
      "#ffffff"
    )}

<span style="color: #00ffff;">PAID AUTO FILTER TELEGRAM BOT</span>
${this.wrapWithColor(
  "2023–2024 | Python, Telethon, Telegram Bot API, token-based auth",
  "#ffffff"
)}

• ${this.wrapWithColor("Auto filter", "#ffa07a")} - ${this.wrapWithColor(
      "Automatically filter and serve movie files in groups",
      "#ffffff"
    )}
• ${this.wrapWithColor("Subscription system", "#ffa07a")} - ${this.wrapWithColor(
      "Token-based paid access control",
      "#ffffff"
    )}

<span style="color: #00ffff;">AGRIRENT PLATFORM</span>
${this.wrapWithColor(
  "2024 | ASP.NET Core MVC, Supabase Storage, Android, MongoDB",
  "#ffffff"
)}

• ${this.wrapWithColor("Agricultural rental", "#ffa07a")} - ${this.wrapWithColor(
      "Platform for renting farm equipment across India",
      "#ffffff"
    )}
• ${this.wrapWithColor("Full-stack", "#ffa07a")} - ${this.wrapWithColor(
      "ASP.NET Core backend + Android mobile app",
      "#ffffff"
    )}

<span style="color: #00ffff;">SMART PLANT IRRIGATION SYSTEM</span>
${this.wrapWithColor(
  "2023 | NodeMCU ESP8266, Blynk IoT, Soil Moisture Sensor, Water Flow Sensor",
  "#ffffff"
)}

• ${this.wrapWithColor("IoT automation", "#ffa07a")} - ${this.wrapWithColor(
      "Auto-irrigates based on real-time soil moisture readings",
      "#ffffff"
    )}
• ${this.wrapWithColor("Remote control", "#ffa07a")} - ${this.wrapWithColor(
      "Monitor and control via Blynk IoT mobile app",
      "#ffffff"
    )}`;
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
      " Bachelor's in CS / IT (Currently Studying) ",
      "#ffffff"
    )}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
  "└──────────────────────────────────────────────────┘",
...
${this.wrapWithColor("🏛️ Institution:", "#ff8c00")} ${this.wrapWithColor(
      "Currently Studying (Gujarat, India)",
      "#ffffff"
    )}
...
${this.wrapWithColor("📚 Subjects:", "#ff8c00")}    ${this.wrapWithColor(
      "Software Engg, Cyber Security, Python, Java, Web Dev, Microprocessors",
      "#ffffff"
    )}

${this.wrapWithColor("📜 Certification:", "#ff8c00")} ${this.wrapWithColor(
      "NPTEL - Programming in Java (NOC25-CS57, IIT Kharagpur, JAN 2025)",
      "#ffffff"
    )}
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
      " Building real projects while still in college! ",
      "#ffffff"
    )}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
  "╰──────────────────────────────────────────────────╯",
...
<span style="color: #00ffff;">Backend & Frontend</span>
• ${this.wrapWithColor("ASP.NET Core MVC / Web API", "#ffffff")}
• ${this.wrapWithColor("Bootstrap", "#ffffff")}

<span style="color: #00ffff;">Databases</span>
• ${this.wrapWithColor("MongoDB", "#ffffff")}
• ${this.wrapWithColor("MSSQL / SQLite", "#ffffff")}
• ${this.wrapWithColor("Supabase Storage", "#ffffff")}

<span style="color: #00ffff;">Telegram Ecosystem</span>
• ${this.wrapWithColor("Telegram Bot API", "#ffffff")}
• ${this.wrapWithColor("Telethon / MTProto", "#ffffff")}
• ${this.wrapWithColor("Auto Filter Bot", "#ffffff")}
• ${this.wrapWithColor("File Streaming", "#ffffff")}

<span style="color: #00ffff;">IoT / Hardware</span>
• ${this.wrapWithColor("NodeMCU ESP8266", "#ffffff")}
• ${this.wrapWithColor("Blynk IoT", "#ffffff")}
• ${this.wrapWithColor("Soil Moisture / Water Flow Sensors", "#ffffff")}

<span style="color: #00ffff;">Deployment / Tools</span>
• ${this.wrapWithColor("Vercel / Koyeb / FTP Deploy", "#ffffff")}
• ${this.wrapWithColor("GitHub / VS Code / Visual Studio", "#ffffff")}`;
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:kachhadiyaharmish@gmail.com" style="color: #ffffff; text-decoration: none;">kachhadiyaharmish@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://harmishkachhadiya.in" target="_blank" style="color: #ffffff; text-decoration: none;">harmishkachhadiya.in</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/Harmish77" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/Harmish77</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://linkedin.com/in/harmishkachhadiya" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/harmishkachhadiya</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("✈", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://t.me/Mr_HKs" target="_blank" style="color: #ffffff; text-decoration: none;">t.me/Mr_HKs</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  loadProjects() {
    this.projects = [
      {
        title: "Telegram Movie Streaming Website",
        description: "Stream movies directly from Telegram using MTProto/Telethon",
        image: "",
        technologies: ["Express.js", "Telegram Bot API", "Koyeb", "Vercel"],
        demo: "https://harmishkachhadiya.in",
        repo: "https://github.com/Harmish77",
      },
      {
        title: "Paid Auto Filter Bot",
        description: "Token-based paid Telegram bot for auto-filtering movie files in groups",
        image: "",
        technologies: ["Python", "Telethon", "Telegram Bot API"],
        demo: "",
        repo: "https://github.com/Harmish77",
      },
      {
        title: "AgriRent Platform",
        description: "Agricultural equipment rental platform (ASP.NET Core + Android)",
        image: "",
        technologies: ["ASP.NET Core MVC", "MongoDB", "Supabase Storage", "Android"],
        demo: "",
        repo: "https://github.com/Harmish77",
      },
      {
        title: "Smart Plant Irrigation System",
        description: "IoT-based auto irrigation using NodeMCU ESP8266 and Blynk",
        image: "",
        technologies: ["NodeMCU ESP8266", "Blynk IoT", "Soil Moisture Sensor", "C++"],
        demo: "",
        repo: "https://github.com/Harmish77",
      },
    ];
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "harmish@kachhadiya: ~/portfolio";
...
╚═╝  ╚═╝╚═╝  ╚═╝`;
    ...
    role.textContent = "Student Developer • Independent Builder • IoT & Bots";
    ...
    url.textContent = "harmishkachhadiya.in";
